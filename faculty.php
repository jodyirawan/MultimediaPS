...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary" style="background: #dff1ec">Faculty List</div>
		<button class="btn btn-light bt-sm" id="new_faculty" style="background: #5fb9a0"><i class="fa fa-plus"></i>	Add New</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
