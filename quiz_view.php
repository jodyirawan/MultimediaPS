...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary" style="background: #dff1ec"><?php echo $qry['title'] ?></div>
		<button class="btn btn-light bt-sm" id="new_question" style="background: #5fb9a0"><i class="fa fa-plus"></i>	Add Question</button>
		<button class="btn btn-light bt-sm" id="new_student" style="background: #5fb9a0"><i class="fa fa-plus"></i>	Add Student</button>
		<br>
		<br>
					...
					<div class="modal-content">
						...
						<form id='question-frm'>
							...
							<div class="modal-footer">
								<button  class="btn btn-light" name="save" style="background: #5fb9a0"><span class="glyphicon glyphicon-save"></span> Save</button>
							</div>
						</form>
					</div>
				</div>
