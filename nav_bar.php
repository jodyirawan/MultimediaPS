			<nav class = "navbar navbar-header navbar-light" style="background: rgb(78 175 148)">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right text-white"><h3>Multimedia Penanggulangan Sampah</h3></p>
				</div>
		...
		<div id="sidebar" class="" style="background: #dff1ec">
